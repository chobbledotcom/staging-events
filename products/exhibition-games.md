...
blocks:
  - type: split
    ...
    content: |-
      ...
      **From £175**
    figure_type: image
    figure_src: images/exhibition-banner-stands.jpg
    figure_alt: Exhibition Games
    button:
      text: Get a Quote
      href: /contact/
      variant: primary
  ...
  - type: features
    ...
    items:
      - icon: mdi:check-circle
        title: 20+ years exhibition experience
        description: ""
      - icon: mdi:check-circle
        title: Wide range of interactive games
        description: ""
      - icon: mdi:check-circle
        title: Custom branding available
        description: ""
      - icon: mdi:check-circle
        title: Trained staff included
        description: ""
      - icon: mdi:check-circle
        title: Major UK venue experience
        description: ""
      - icon: mdi:check-circle
  ...
  - type: stats
    items:
      ...
      - value: Exhibitions, trade shows, activations
        label: Best For
  - type: cta
    title: Hire the Exhibition Games
