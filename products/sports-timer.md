...
features:
  - Digital countdown and elapsed timing
  - High-visibility LED display
  - Visible to participants and spectators
  - Pairs with start and finish gantries
  - Operated by experienced event crew
  - UK-wide delivery and setup
specs:
  - name: Display
    value: High-visibility LED
  - name: Modes
    value: Countdown and elapsed
  - name: Setup
    value: Included with hire
  - name: Delivery
    value: UK-wide
gallery:
