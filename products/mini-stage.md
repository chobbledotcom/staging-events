...
features:
  - 3m x 3m stage area
  - Suits DJs and solo acts
  - Up to 3-piece band capacity
  - Multiple height options
  - Professional setup included
  - Accessible ramp available
specs:
  - name: Size
    value: 3m x 3m
  - name: Hire Price
...
blocks:
  ...
  - type: split-image
    content: |-
      ...
      **From £925**
    figure_src: images/performer-jumping-mini-stage.jpg
    figure_alt: Mini Stage 3x3m
    button:
      text: Get a Quote
      href: /contact/
      variant: primary
