---
name: Crowd Barriers and Belt Barriers
...
blocks:
  - type: split-image
    subtitle: Crowd Barriers and Belt Barriers
    content: |-
      ...
      **From £7.50**
    figure_src: images/memory-walk-crowd-with-barriers.jpg
    figure_alt: Crowd Barriers and Belt Barriers
    button:
      text: Get a Quote
      href: /contact/
      variant: primary
  ...
  - type: features
    ...
    items:
      ...
      - icon: mdi:check-circle
        name: VIP and backstage separation
        description: ""
      - icon: mdi:check-circle
        name: Venue access control
  ...
  - type: features
    ...
    items:
      - icon: mdi:check-circle
        name: Tensa belt barriers
        description: ""
      - icon: mdi:check-circle
        name: Stretch barriers
        description: ""
      - icon: mdi:check-circle
        name: Professional crowd management
        description: ""
      - icon: mdi:check-circle
        name: Exhibition and event use
        description: ""
      - icon: mdi:check-circle
        name: Bulk quantities available
        description: ""
      - icon: mdi:check-circle
