...
specs:
  ...
  - name: Output
    value: Boomerang-style videos
  - name: Sharing
    value: Instant social uploads
  - name: Staff
    value: Trained attendant included
  - name: Best For
    value: Product launches, campaigns
eleventyNavigation:
  key: 360 Photo Booth
  parent: Photo Booths
blocks:
  ...
  - type: features
    ...
    items:
      - icon: mdi:check-circle
        ...
        description: ""
      - icon: mdi:check-circle
        title: Motorised rotating arm
        description: ""
      - icon: mdi:check-circle
        title: Boomerang-style videos
        description: ""
      - icon: mdi:check-circle
  ...
  - type: stats
    items:
      ...
      - value: Product launches, campaigns
        label: Best For
  - type: cta
    title: Hire the 360 Photo Booth
