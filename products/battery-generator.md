...
features:
  ...
  - Over 10kg CO2 saved per hour vs diesel
  - 2.1 kWh capacity
  - Quiet operation
  - No fumes
specs:
  ...
  - name: Capacity
    value: 2.1 kWh
  - name: CO2 Savings
    value: Over 10kg/hour vs diesel
  - name: Power Type
    value: Battery
gallery:
...
blocks:
  - type: split
    ...
    content: |-
      ...
      **Contact for pricing**
    figure_type: image
    figure_src: images/band-on-stage-green-lights.jpg
    figure_alt: Battery Generator (Instagrid)
    button:
      text: Get a Quote
      href: /contact/
      variant: primary
