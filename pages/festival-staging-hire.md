...
blocks:
  ...
  - type: split-image
    ...
    content: |
      ...
      If you're running a festival and want to talk through what you need, someone's usually about on [0845 468 0610](tel:+448454680610).
    button:
  ...
  - type: items
    ...
    intro_content: |
      ...
      Our range of mobile and modular stages for outdoor events.
  ...
  - type: image-background
    ...
    image_alt: Performers on stage at an outdoor festival
    content: |-
      ## On the Ground

      From Rotherham to wherever your festival is, with our own vehicles, our own crew and our own kit.
